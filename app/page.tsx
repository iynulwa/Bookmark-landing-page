      ...
      <main className="grid place-items-center gap-10 grid-layout overflow-hidden">
        ...
        <section className="hero flex items-center justify-center flex-col md:flex-row gap-4 md:justify-between">
          ...
          <div className="flex flex-col gap-4 *:md:text-left md:items-start md:w-1/2">
            <h1 className="text-4xl font-medium text-center">A Simple Bookmark manager</h1>
            ...
            <div className="flex items-center justify-center gap-4 my-4">
              <button className="hero-btn-main py-5 px-4 rounded-lg bg-[var(--clr-blue-600)] text-white">Get it in Chrome</button>
              <button className="hero-btn-second py-5 px-4 rounded-lg bg-[var(--clr-grey-50)] text-black drop-shadow">Get it in Firefox</button>
            </div>
          </div>
        </section>
        <Features />
